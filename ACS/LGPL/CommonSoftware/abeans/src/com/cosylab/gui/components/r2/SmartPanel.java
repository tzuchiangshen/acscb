 ...
 * Creation date: (1.2.2002 16:38:16)
 * @author: 
 */
...
public java.lang.String getName() {
	if (!isDialog) return getShortName();
...
public java.lang.String getShortName() {
	if (shortName==null) return super.getName();
	return shortName;
}
/**
...
public static void main(java.lang.String[] args) {
	try {
		...
		SmartPanel aSmartPanel;
		aSmartPanel = new SmartPanel();
		javax.swing.JTabbedPane tPane=new javax.swing.JTabbedPane();
		tPane.add(aSmartPanel);
		javax.swing.JPanel panel=new javax.swing.JPanel();
		panel.setLayout(new java.awt.CardLayout(4,4));
		panel.add(tPane,"Test");
		frame.setContentPane(panel);
		frame.setSize(tPane.getSize());
...
public void showPopup(java.awt.event.MouseEvent mouseEvent) {
    if (java.awt.event.MouseEvent.META_MASK == mouseEvent.getModifiers()) {
	    if (getJPopupMenu1().getComponents().length<1) getJPopupMenu1().add(getJMenuItem1());
...
/*			((javax.swing.JTabbedPane)oldParent).setDoubleBuffered(false);
	...
	System.out.println("toDialog called");
	return;
}
}
