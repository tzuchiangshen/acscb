...
*
* "@(#) $Id: bulkDataNTSenderStream.cpp,v 1.14.2.1 2012/06/19 09:30:01 bjeram Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
static char *rcsId="@(#) $Id: bulkDataNTSenderStream.cpp,v 1.14.2.1 2012/06/19 09:30:01 bjeram Exp $";
...
BulkDataNTSenderStream::~BulkDataNTSenderStream()
{
	...
	ACS_LOG(LM_RUNTIME_CONTEXT, __FUNCTION__, (LM_INFO, "Sender Stream: %s has been destroyed.", streamName_m.c_str()));
 }//~BulkDataNTSenderStream
