...
public final class DummyWindowManager extends WindowManager {
	private final static Log log = LogFactory.getLog(DummyWindowManager.class);
    ...
    public DummyWindowManager() {
        log.debug("instantiating DummyWindowManager");
    ...
    public synchronized R registry() { //// 
		...
		log.debug("returning dummy TopComponent.Registry() R():" + r);
        return r;
    }
    ...
    private final class TCM implements WindowManager.Component {
        ...
        public void setActivatedNodes(Node[] nodes) {
        	log.debug("activated nodes: " + nodes); ////
            this.nodes = nodes;
